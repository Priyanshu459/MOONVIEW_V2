...
function getAllSectionsToShow(userSettings, sectionCount) {
    ...
    // Moonview Phase 3 Correction: Always remove 'My Media' dashboard feel from Home
    sections = sections.filter(s => s !== HomeSectionType.SmallLibraryTiles && s !== HomeSectionType.LibraryButtons);
